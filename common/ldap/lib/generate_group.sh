...
# Constants
GROUP_TEMPLATE_FILE="common/ldap/templates/group.ldif"
...
# Built Variables
GROUP_TEMPLATE_FILE_PATH="${working_dir}/${GROUP_TEMPLATE_FILE}"

# Check Variables
if [ ! -f "${GROUP_TEMPLATE_FILE_PATH}" ]; then
    log "ERROR" "Unable to find template file: ${GROUP_TEMPLATE_FILE_PATH}"
    usage
fi
...
start_epoch=$(date '+%s')
echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
log "INFO" "Running Generate Group"
...
log "INFO" "Generate Group elapsed script time (in seconds): ${script_duration}"
echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"